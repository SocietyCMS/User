...
<ol class="breadcrumb">
    ...
    <li class=""><a href="{{ URL::route('backend::user.user.index') }}">{{ trans('user::users.breadcrumb.users') }}</a></li>
...
@stop
@section('content')
{!! Form::open(['route' => 'backend::user.user.store', 'method' => 'post']) !!}
<div class="row">
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-danger pull-right btn-flat" href="{{ URL::route('backend::user.user.index')}}"><i class="fa fa-times"></i> {{ trans('user::button.cancel') }}</a>
                </div>
            </div>
        </div>
